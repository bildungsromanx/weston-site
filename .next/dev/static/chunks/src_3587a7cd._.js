...
function Footer() {
    ...
    if ($[0] !== "ca97fa1fb55a0a645acc3f1b38c8331962b9aed23b9a4f78e5af66df1459e814") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ca97fa1fb55a0a645acc3f1b38c8331962b9aed23b9a4f78e5af66df1459e814";
    }
    let t0;
...
function ThemeProvider(t0) {
    ...
    if ($[0] !== "0984fefbd59dddb76aad54821da6f28aea8350e4ca9765091a38b48e13ea3bef") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "0984fefbd59dddb76aad54821da6f28aea8350e4ca9765091a38b48e13ea3bef";
    }
    const { children } = t0;
...
"[project]/src/components/ThemeToggle.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function RootLayout(t0) {
    ...
    if ($[0] !== "064cef36b9af9920d9b5a397ac255f280f591c0d9655980af35678d1cb77d393") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "064cef36b9af9920d9b5a397ac255f280f591c0d9655980af35678d1cb77d393";
    }
    const { children } = t0;
    let t1;
    let t2;
...
//# sourceMappingURL=src_3587a7cd._.js.map